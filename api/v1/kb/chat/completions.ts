...
/**
 * Terpedia KB-specific /v1/kb/chat/completions endpoint
 * Forces model to terpedia/kb and proxies to backend
 */
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Force model to terpedia/kb
    payload.model = 'terpedia/kb';
    ...
    const terpediaBackendUrl = terpediaBackendBase.replace(/\/$/, '') + '/v1/kb/chat/completions';
