...
/**
 * Terpedia PubMed-specific /v1/pubmed/chat/completions endpoint
 * Forces model to terpedia/pubmed and proxies to backend
 */
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Force model to terpedia/pubmed
    payload.model = 'terpedia/pubmed';
    ...
    const terpediaBackendUrl = terpediaBackendBase.replace(/\/$/, '') + '/v1/pubmed/chat/completions';
